    ...
    <main className="relative max-w-7xl mx-auto px-6 py-24 overflow-hidden">
      ...
      <div className="relative grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          >
            I’m a cloud enthusiast with an architectural mindset, a
            management-certified professional, and a backend-focused
            project builder. I enjoy designing scalable systems,
            implementing secure APIs, and taking ideas from planning
            to production using modern cloud workflows.
          </motion.p>
